...
<div class="help">
    ...
    <p><?php __('Monivalinnassa valitse vaihtehdoista mielestäsi asiaa parhaiten kuvaava vaihtoehto.'); ?></p>
    ...
    <p><?php __('Joidenkin kysymysten yhteydessä kartalla voi näkyä kysymykseen liittyvältä karttamerkkejä, viivoja, alueita sekä karttakuvia.'); ?></p>
