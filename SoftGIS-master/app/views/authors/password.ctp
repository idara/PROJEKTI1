...
<?php
	...
	echo $this->Form->input('retypedPassword', array('type'=>'password', 'label' => __('Vahvista salasana', true), 'title' => __('Vaihtaaksesi salasanan, syötä uusi salasana molempiin kenttiin.', true), 'after' => '<span class="afterInput">Kirjoitusvirheiden ehkäisemiseksi, syötä uusi salasana molempiin kenttiin.</span>'));
