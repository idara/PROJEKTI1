            ...
            <tr>
                <td>
                    <?php echo $this->Html->link(
                        ...
                        array('title' => __('Katsele karttakerkkiä', true))
                        );
                    ?>
                </td>
                <td>
                    <?php echo $this->Html->link(
                        ...
                        array('title' => __('Muokkaa karttakerkkiä', true))
                        );
                    ?>
                </td>
                <td>
                ...
                <td>
                    <?php echo $this->Html->link(
                        ...
                        __('Oletko varma että haluat kopioida karttakerkin?', true)
                        );
                    ?>
                </td>
                <td>
                    <?php echo $this->Html->link(
                        ...
                        __('Oletko varma että haluat poistaa karttakerkin?', true)
                        );
                    ?>
                </td>
                <td>
