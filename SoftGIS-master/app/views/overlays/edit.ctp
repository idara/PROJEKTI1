...
<div class="form">
    ...
    <div class="help">
        ...
        <p><?php __('Voit syöttää kuvan lounais- ja koilliskulman koordinaatit niille varattuihin kenttiin ja ohjelma asettaa karttakuvan kartalle. Esikatselussa karttakuva on läpinäkyvä kohdistamisen helpottamiseksi, mutta kyselyssä läpinäkyvyyttä ei ole.'); ?></p>
        <h2><?php __('Kulmamerkit kartalle'); ?></h2>
        <p><?php __('Voit myös asettaa karttakuvan kohdalleen klikkaamalla karttaa karttakuvan lounais- ja koilliskulmien kohdalta. Kartalle ilmestyy merkit kuvan kulmien paikaksi. Kulmien merkkejä voi vetämällä siirtää, tai hiiren oikealla klikkauksella poistaa.'); ?></p>
    </div>
